...
- **Strict Permission Enforcement:** To manage rules or the dashboard, moderators must possess the **Manage Server** permission on _all_ linked guilds.
  - _Note:_ If permissions are missing, the bot will display an alert prompting you to fix the permissions or purge the invalid rules.

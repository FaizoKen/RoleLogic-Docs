...
- **API reference built-in:** The dashboard includes a quick API reference showing all available endpoints so developers integrating with your server can get started quickly. Full API documentation is available at [Role Link API Reference](/reference/role-link-api).
